...
VideoConverter::VideoConverter(const std::size_t width, const std::size_t height,
  ...
  sws_ctx_.reset(sws_getContext(width_, height_, src_format_, width_, height_, dst_format_, 0,
...
std::string VideoConverter::dst_format_name() const { return av_get_pix_fmt_name(dst_format_); }
