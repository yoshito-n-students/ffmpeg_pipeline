        ...
        [&](const sensor_msgs::msg::CompressedImage::SharedPtr packet_data) {
          try {
            ...
            while (true) {
              ...
              if (!converter) {
                converter = av::VideoConverter::create(frame->width, frame->height,
              ...
              auto image = std::make_unique<sensor_msgs::msg::Image>(frame.to_image_msg(
                  packet_data->header.stamp, sensor_msgs::image_encodings::BGR8));
