...
class VideoPacketBroadcaster : public BroadcasterBase<sensor_msgs::msg::CompressedImage> {
public:
  VideoPacketBroadcaster()
      : BroadcasterBase<sensor_msgs::msg::CompressedImage>(/* default_sensor_name = */ "camera",
                                                           /* topic = */ "~/image/ffmpeg") {}
